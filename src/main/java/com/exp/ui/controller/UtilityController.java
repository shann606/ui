...
public class UtilityController {
	...
	public ResponseEntity<List<Expense>> expenseDetails() {
		...
		List<Expense> expense = List.of(
				new Expense(ThreadLocalRandom.current().nextInt(1000, 10000), "Veg", new BigDecimal(1200), formatted),
				new Expense(ThreadLocalRandom.current().nextInt(1000, 10000), "Fruits", new BigDecimal(234), formatted),
				new Expense(ThreadLocalRandom.current().nextInt(1000, 10000), "Hotel", new BigDecimal(12345),
						formatted),
				new Expense(ThreadLocalRandom.current().nextInt(1000, 10000), "Trip", new BigDecimal(6000), formatted));
